...
namespace ManusVR.Polygon
{
	public class SkeletonBoneScalers
	{
		...
		{
			AddScalerBone(HumanBodyBones.Hips, bones.body.hip.bone, boneRotations.body.hip.bone.rotation);
			AddScalerBone(HumanBodyBones.Spine, bones.body.spine[0].bone, boneRotations.body.spine[0].bone.rotation);
			if (bones.body.spine[1]?.bone != null) AddScalerBone(HumanBodyBones.Chest, bones.body.spine[1].bone, boneRotations.body.spine[1].bone.rotation);
			if (bones.body.spine[2]?.bone != null) AddScalerBone(HumanBodyBones.UpperChest, bones.body.spine[2].bone, boneRotations.body.spine[2].bone.rotation);

			AddScalerBone(HumanBodyBones.Neck, bones.head.neck.bone, boneRotations.head.neck.bone.rotation);
			AddScalerBone(HumanBodyBones.Head, bones.head.head.bone, boneRotations.head.head.bone.rotation, false);

			// Arms
			AddScalerBone(HumanBodyBones.LeftShoulder, bones.armLeft.shoulder.bone, boneRotations.armLeft.shoulder.bone.rotation);
			AddScalerBone(HumanBodyBones.LeftUpperArm, bones.armLeft.upperArm.bone, boneRotations.armLeft.upperArm.bone.rotation);
			AddScalerBone(HumanBodyBones.LeftLowerArm, bones.armLeft.lowerArm.bone, boneRotations.armLeft.lowerArm.bone.rotation);

			AddScalerBone(HumanBodyBones.RightShoulder, bones.armRight.shoulder.bone, boneRotations.armRight.shoulder.bone.rotation);
			AddScalerBone(HumanBodyBones.RightUpperArm, bones.armRight.upperArm.bone, boneRotations.armRight.upperArm.bone.rotation);
			AddScalerBone(HumanBodyBones.RightLowerArm, bones.armRight.lowerArm.bone, boneRotations.armRight.lowerArm.bone.rotation);

			// Legs
			AddScalerBone(HumanBodyBones.LeftUpperLeg, bones.legLeft.upperLeg.bone, boneRotations.legLeft.upperLeg.bone.rotation);
			AddScalerBone(HumanBodyBones.LeftLowerLeg, bones.legLeft.lowerLeg.bone, boneRotations.legLeft.lowerLeg.bone.rotation);
			AddScalerBone(HumanBodyBones.LeftFoot, bones.legLeft.foot.bone, boneRotations.legLeft.foot.bone.rotation, false);
			...
			AddScalerBone(HumanBodyBones.RightUpperLeg, bones.legRight.upperLeg.bone, boneRotations.legRight.upperLeg.bone.rotation);
			AddScalerBone(HumanBodyBones.RightLowerLeg, bones.legRight.lowerLeg.bone, boneRotations.legRight.lowerLeg.bone.rotation);
			AddScalerBone(HumanBodyBones.RightFoot, bones.legRight.foot.bone, boneRotations.legRight.foot.bone.rotation, false);
			...
			// Hands
			AddScalerBone(HumanBodyBones.LeftHand, bones.armLeft.hand.wrist.bone, boneRotations.armLeft.hand.wrist.bone.rotation, false);
			...
			AddScalerBone(HumanBodyBones.RightHand, bones.armRight.hand.wrist.bone, boneRotations.armRight.hand.wrist.bone.rotation, false);
		...
		public void AddScalerBone(HumanBodyBones humanBone, Transform bone, Quaternion boneLookRotation, bool counterScaleChildren = true)
		{
			if (!boneScalers.ContainsKey(humanBone))
			{
				boneScalers.Add(humanBone, new BoneScaler(bone, boneLookRotation, counterScaleChildren));
			}
		}
	}
}
