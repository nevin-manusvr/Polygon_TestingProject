...
namespace Manus.ToBeHermes.Retargeting
{
	...
	public class SkeletonRetargeter : MonoBehaviour
	{
		...
		private Dictionary<BoneType, Manus.Polygon.Skeleton.Bone> mainBonesCollection;
		private Dictionary<BoneType, Manus.Polygon.Skeleton.Bone> retargetBonesCollection;
		...
		private void ApplyRetargeting()
		{
			foreach (RetargetContraint constraint in retargetConstraints)
			{
				...
				Manus.Polygon.Skeleton.Bone bone = null;
		...
		{
			foreach (KeyValuePair<BoneType, Manus.Polygon.Skeleton.Bone> bone in retargetBonesCollection)
			{
				foreach (KeyValuePair<BoneType, Manus.Polygon.Skeleton.Bone> mainBone in mainBonesCollection)
				{
