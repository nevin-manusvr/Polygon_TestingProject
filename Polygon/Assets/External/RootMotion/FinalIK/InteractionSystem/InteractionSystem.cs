...
namespace RootMotion.FinalIK {
	...
	public class InteractionSystem : MonoBehaviour {
		...
		/// <summary>
		/// If not empty, only the targetOffsets with the specified tag will be used by this Interaction System.
		/// </summary>
		[Tooltip("If not empty, only the targetOffsets with the specified tag will be used by this Interaction System.")]
