...
namespace RootMotion.FinalIK {
	...
	public partial class IKSolverVR: IKSolver {
		...
		/// <summary>
		/// Adds position offset to a body part. Position offsets add to the targetOffsets in VRIK.
		/// </summary>
		...
		/// <summary>
		/// Adds rotation offset to a body part. Rotation offsets add to the targetOffsets in VRIK
		/// </summary>
