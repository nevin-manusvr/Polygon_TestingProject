...
namespace RootMotion.Demos {
	...
	// Targeting hands to 2-handed props with the FullBodyBipedIK component. It is not good to parent IK targetOffsets directly to the bones that use IK (circular dependency).
	// The bones are moved in the solving process, but it will not update the IK targetOffsets parented to the bones. All IK target positions/rotations need to be set before the solver updates.
