...
namespace RootMotion.Demos {
	...
	/// As the IK targetOffsets of one FBBIK partner depend on the solved pose of another FBBIK partner and vice versa, the rig will have to be iterated a couple of times to make it work.
	/// </summary>
	public class KissingRig : MonoBehaviour {
		...
		public class Partner {
			...
			public Transform touchTargetLeftHand, touchTargetRightHand; // Touch targetOffsets for the hands
			...
			public void Update(float weight) {
				...
				// Set hand effector positions to touch targetOffsets
		...
		// As the IK targetOffsets of one FBBIK partner depend on the solved pose of another FBBIK partner and vice versa, 
